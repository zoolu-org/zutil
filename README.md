...
* [json](https://github.com/zoolu-org/zutil/tree/main/src/org/zoolu/util/json) - a very small JSON implementation; simple to use through static methods of the [Json](https://github.com/zoolu-org/zutil/blob/main/src/org/zoolu/util/json/Json.java) class;
